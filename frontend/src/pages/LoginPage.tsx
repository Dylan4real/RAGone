...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4">
      <div className="absolute inset-0 bg-gradient-to-br from-canvas via-surface-soft to-surface-card dark:from-surface-dark dark:via-dark-elevated dark:to-dark-elevated" />
